...
core_means_joined <- importAURN(site = core_urb_traff_sites, year = 2017:2020, pollutant = "no2") %>% 
...
The time variation of traffic flows drives the variation in measured concentrations of traffic pollutants, especially NOx, which is closely coupled to exhaust emissions. The chart below summarises data from before and during the lockdown. The sites selected were those close to the air quality monitoring sites.
