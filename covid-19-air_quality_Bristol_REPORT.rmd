...
```{r Traffic flows by sector, eval = TRUE, echo = FALSE, results = "show", out.width = '100%', fig.width = 14, fig.height = 12, fig.cap = "Fig 2. Traffic flows by sector: 2020"}
...
Analysis of the time variation of NOx shows a drastic reduction at all hours of the day when compared to the same period in 2019. Again, while this cannot be be attributed solely to the lockdown measures, it is likely that traffic reductions arising from lockdown play a significant role.
...
```
```{r data viz timeVariation NOx show, eval = TRUE, echo = FALSE, results = "show", fig.height = 7, fig.width = 11, fig.cap = "Fig 7. Time variation of NOx at roadside sites in lockdown period by hour"}
...
```{r data viz timeVariation NOx show day, eval = TRUE, echo = FALSE, results = "show", fig.height = 7, fig.width = 11, fig.cap = "Fig 8. Time variation of NOx at roadside sites in lockdown period by day"}
...
```{r data viz timeVariation NO2 show, eval = TRUE, echo = FALSE, results = "show", , fig.height = 7, fig.width = 11, fig.cap = "Fig 9. Time variation of NO2 at roadside sites in lockdown period by hour"}
...
```{r data viz timeVariation PM10 show, eval = TRUE, echo = FALSE, results = "show", fig.height = 7, fig.width = 11, fig.cap = "Fig 10. Time variation of PM10 in lockdown period by hour"}
...
```{r data viz Meteorology, eval = TRUE, echo = FALSE, warning = FALSE, results = "show", fig.height = 7, fig.width = 10, fig.cap = "Fig 11. Wind roses for lockdown periods: Bristol Lulsgate"}
...
```{r table sites, eval = TRUE, echo = FALSE, warning = FALSE, message = FALSE, results = "show", fig.height = 7, fig.width = 10, fig.cap = "Fig 12. Sites aggregated for model analysis"}
...
save(aq_data_DT, met_data_DT, aq_monitors, core_raw, allsites_meta, models_plots, models_plots_sites, file = here::here("dfs.RData"))
...
```{r deweather chart, eval = TRUE, echo = FALSE, warning = FALSE, message = FALSE, results = "show", fig.height = 7, fig.width = 10, fig.show = "show", fig.cap = "Fig 13. Deweathered chart by site class"}
rdf_P <- rect_df %>% 
...
```{r deweathered predictions of NOx and NO2 by site, eval = TRUE, echo = FALSE, warning = FALSE, message = FALSE, results = "show", fig.height = 7, fig.width = 10, fig.show = "show", fig.cap = "Fig 14. Deweathered chart by site: NOx and NO2"}
...
fbracket <- function(x) str_replace(x, "\\(", "\\[") # function to change weird formatting of 
#brackets when cut_number bins the continuous data

dwp_plot_site <- models_plots_sites %>% 
  ...
  filter(!is.na(delta_binned)) %>% #get rid of NA in legend
  ...
  labs(x = "Date", y = "Site", fill = "% difference between \n de - weathered \n prediction and \n mean for 2020", title = "Variation between de - weathered predictions and mean concentrations in 2020") +
  theme_report_facet() +
...
ggsave(dwp_plot_site, filename = here::here("plots", "deweathered_no2_nox_sites.png"), device = "png", dpi = 200, width = 10, height = 12)
...
```{r cusum analysis, eval = TRUE, echo = FALSE, warning = FALSE, message = FALSE, results = "hide", fig.height = 7, fig.width = 10, , fig.show = "show", fig.cap = "Fig 15. Cusum chart of NOx data"}
