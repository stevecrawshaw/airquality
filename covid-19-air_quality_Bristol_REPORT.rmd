...
dateTo = "2020-05-15" #final day of lockdown period (or latest date for monitoring data)
...
save(aq_data_DT, met_data_DT, aq_monitors, core_raw, allsites_meta, models_plots, models_plots_sites, monthly_tubes, wards, dt_locs, scoot_daily, aq_sites_scoot, file = here::here("dfs.RData"))
...
The time variation of traffic flows drives the variation in measured concentrations of traffic pollutants, especially NOx, which is closely coupled to exhaust emissions. The chart below summarises data from before and during the lockdown.
